    ...
    connectionUser.invoke('Matricular',strLayouCodigoUsuario)
        ...
        .then(function (result) {
            $.each(result, function (index,value) {
                agregarNotificacionSuscripcion(value);
            });
...
function agregarNotificaciones(notificacion) {
    ...
    aAnchor.prop("href", "javascript:void(0)");
    ...
    divDetalle.html(notificacion.creacionFecha)
...
function agregarNotificacionSuscripcion(value) {
