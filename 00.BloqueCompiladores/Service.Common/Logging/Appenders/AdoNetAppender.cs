...
namespace Service.Common.Logging.Appenders
{
    public class AdoNetAppender : BufferingAppenderSkeleton
    {
        ...
        public void AddParameter(Service.Common.Logging.Parameters.AdoNetAppenderParameter parameter)
        {
        ...
        virtual protected void SendBuffer(IDbTransaction dbTran, LoggingEvent[] events)
        {
            if (_UsePreparedCommand)
            {
                if (_DbCommand != null)
                {
                    ...
                    {
                        foreach (Service.Common.Logging.Parameters.AdoNetAppenderParameter param in _Parameters)
                        {
